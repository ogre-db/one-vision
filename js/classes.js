...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openInfo (event) {
        ...
        let derivedList = [
            Math.round(item.strgrw * 0.9 + item.dexgrw * 0.7),
            Math.round(item.strgrw * 0.7 + item.dexgrw * 1.1),
            Math.round(item.strgrw * 0.7 + item.vitgrw * 1.1),
            Math.round(item.dexgrw * 1 + item.agigrw * 1.2),
            Math.round(item.dexgrw * 1 + item.avdgrw * 1.2),
            Math.round(item.intgrw * 1 + item.mndgrw * 0.9),
            Math.round(item.mndgrw * 0.8 + item.resgrw * 1),
            Math.round(item.intgrw * 1.2 + item.mndgrw * 1.2),
            Math.round(item.avdgrw * 1.2 + item.mndgrw * 0.8),
            Math.round(item.avdgrw * 1.2 + item.agigrw * 0.8)
        ];
