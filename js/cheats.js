...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateChRenameCodes() {
        ...
        if (chRenameRoster.value === '') {
        ...
        } else if ( chRenameName.value === '' || chRenameName.value.length > 20 ) {
            ...
            chRenameResult.innerHTML += '<br>_L 0x00' + decToHex(parseInt('2D847C', 16) + 1164 * (rosterSlot - 1), 3) + ' 0x00000001';
            let nameSegment = '';
            for (let i = 0; i < 20; i++) {
                if (newName.charAt(i))
                ...
                if (i % 4 === 3) {
                    chRenameResult.innerHTML += '<br>_L 0x20' + decToHex(parseInt('2D847D', 16) + 1164 * (rosterSlot - 1) + (i - 3), 3) + ' 0x' + nameSegment;
                    nameSegment = '';
                }
            }
            chRenameResult.innerHTML += '<br>_L 0x80' + decToHex(parseInt('2D8491', 16) + 1164 * (rosterSlot - 1), 3) + ' 0x00120001';
